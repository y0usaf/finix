...
in {
  options.finix = {
    basePkgs = lib.mkOption {
      type = lib.types.raw;
      description = "Shared non-CUDA package set with Finix overlays.";
      default = basePkgs;
    };
    mkSystem = lib.mkOption {
      type = lib.types.functionTo lib.types.raw;
      description = "Construct a Finix host using the shared module and package policy.";
      default = mkFinixSystem;
    };
  };
}
