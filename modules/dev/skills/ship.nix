{
  ...
  # prime-agent, ...). Kept out of modules/dev/pi/ so the skill is not tied to
  # one agent — extend the list to reach claude/codex too. Each agent loads
  # skills from <agentDir>/skills; the same content is placed in each root.
  roots =
