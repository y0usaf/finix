# Desktop packet filter — SINGLE SOURCE OF TRUTH.
#
...
# ../../../modules was silently discarded, and finix/default.nix imported the
# upstream `nftables` module into serverPersistent only. Live proof at audit
# time: nft / iptables / ip6tables all absent from the system.
#
